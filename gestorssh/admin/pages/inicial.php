    ...
    <div class="col-12">
        <div class="card card-profile border-primary">
            ...
            <div class="card-body">
                ...
                <h3>BEM VINDO <?php echo strtoupper($administrador['nome']); ?></h3>
            ...
            <div class="card border-primary">
                <a href="home.php?page=ssh/contas">
                    <div class="card-header d-flex flex-column align-items-center pb-0">
                        ...
                        <h4 class="text-bold-700 mt-1"><?php echo $ssh_susp_qtd; ?> CONTAS SUSPENSAS.</h4>
                        <p class="mb-2"></p>
                    </div>
                </a>
            </div>
            ...
            <div class="card border-primary">
                <a href="home.php?page=usuario/revenda">
                    <div class="card-header d-flex flex-column align-items-center pb-0">
                        ...
                        <h4 class="text-bold-700 mt-1"><?php echo $revenda_qtd_susp; ?> REVENDA SUSPENSA.</h4>
                        <p class="mb-2"></p>
                    </div>
                </a>
            </div>
