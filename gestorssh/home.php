...
<head>
    ...
    <meta name="keywords" content="QSS NET">
    <meta name="author" content="QSS NET">
                            ...
                            <li class="scrollable-container media-list">
                                <div class="list-item d-flex align-items-start">
                                    ...
                                    <div class="list-item-body flex-grow-1">
                                        <p class="media-heading"><span class="fw-bolder">SEM USÚARIOS ONLINE</span></p>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="false">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="active"><a class="d-flex align-items-center" href="home.php"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboards">INÍCIO</span></a></li>
                <li class=" navigation-header"><span>QSS NET</span>
                </li>
                ...
                <?php if (($usuario['tipo'] == "revenda") and ($acesso_servidor > 0)) { ?>
                    <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i class="text-warning" data-feather="server"></i><span class="menu-title text-truncate" data-i18n="Alterar">SERVIDORES</span><span class="badge badge-light-warning rounded-pill ms-auto me-1"><?php echo $acesso_servidor; ?></span></a>
                        <ul class="menu-content">
                            <li><a href="?page=servidor/listar"><i data-feather='hard-drive'></i><span class="menu-item" data-i18n="Meus Sevidores">LISTAR SERVIDORES</span></a>
                            </li>
